...
public class JisickinController {
    ...
    @ApiResponses({
            @ApiResponse(code = 200, message = "성공", response = JisickinRes.class),
    ...
    public ResponseEntity<?> getJisickinDetail(
            @RequestParam @ApiParam(value = "질문 Uid", required = true) Long uid
    ) {
